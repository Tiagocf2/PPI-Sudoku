class Sudoku{
    constructor(elemento_HTML, size = 500, boardSize = 9){
        ...
        this.canvas.addEventListener('focusout', this.unfocus);
        this.canvas.addEventListener('mouseup', this.handleMouse);
    ...
    */
	...
	handleMouse(e){
		...
		/* Seleciona o quadrado na posição (X, Y) */
